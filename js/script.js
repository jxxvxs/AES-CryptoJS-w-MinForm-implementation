...
function decrypt() {
    ...
    if(decrypted == '')
    {
        document.querySelector("#result").value = "There's something wrong."
    }
}


// Board utilities
function pasteField(parameterID) {
    navigator.clipboard.readText()
    .then(text => {
        document.getElementById(parameterID).value = text;
    });
}
...
function clearField(parameterID) {
    document.querySelector(parameterID).value = "";
}
